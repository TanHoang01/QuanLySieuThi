    ...
    class GoodsDAO : DataProvider
    {
        ...
        public void AddNewGoods(Goods goods)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionSTR))
            {
                ...
                {
                    connection.Open();
                    SqlCommand command = new SqlCommand("INSERT INTO Goods VALUES (@MaHangHoa,@TenHang,@DonVi,@SoLuong,@DonGia,@GhiChu)", connection);
                    ...
                    command.Parameters.AddWithValue("@GhiChu", goods.GhiChu);
                    command.ExecuteNonQuery();
                    connection.Close();
                }
                catch
                {
                    MessageBox.Show("Mã Của Một Số Mặt Hàng Đã Tồn Tại!", "Thông Báo", MessageBoxButtons.OK);
                }
            }
        ...
        public void ReceiptGoods(Receipt receipt)
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionSTR))
            {
                ...
                {
                    MessageBox.Show("Cập Nhập Nhập Hàng Lỗi!", "Thông Báo", MessageBoxButtons.OK);
                }
            }
